...
def main():
    parser = argparse.ArgumentParser(description='Convert line drawings to G-Code')
    parser.add_argument('input_file', help='Input file (PNG, JPG, or SVG)')
    parser.add_argument('-o', '--output', help='Output G-Code file (default: input_file.nc)')
    ...
    if args.output:
        ...
        output_file = input_path.with_suffix('.nc')
